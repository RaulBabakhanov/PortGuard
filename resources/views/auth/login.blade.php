        ...
        <aside class="login-brand">
            ...
            <svg class="login-map" viewBox="0 0 800 600" aria-hidden="true">
                ...
                <g class="login-map-lines">
                    <path d="M90 420 C180 360, 220 300, 310 280 S470 250, 540 180" />
                    <path d="M140 120 C240 160, 280 220, 310 280 S390 390, 520 450" />
                    <path d="M40 260 C130 240, 210 250, 310 280 S480 310, 650 290" />
                    <path d="M310 280 L420 140" />
                    <path d="M310 280 L620 380" />
                </g>
            ...
            <div class="login-brand-copy">
                <p class="login-eyebrow">Güvenli ağ izleme</p>
                <h1 class="login-title">PortGuard</h1>
                <p class="login-lead">
                    Servisleri keşfedin, portları izleyin ve kullanıcı hareketlerini tek yerden takip edin.
                </p>
            </div>
        </aside>
